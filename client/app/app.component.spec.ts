...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[1].nativeElement.textContent).toContain('Characters');
    ...
    expect(de[1].attributes['routerLink']).toBe('/characters');
  ...
  it('should display the navigation bar correctly for logged users', () => {
    ...
    expect(de[0].nativeElement.textContent).toContain('Home');
    expect(de[1].nativeElement.textContent).toContain('Opponents');
    ...
    expect(de[0].attributes['routerLink']).toBe('/');
    expect(de[1].attributes['routerLink']).toBe('/opponents');
